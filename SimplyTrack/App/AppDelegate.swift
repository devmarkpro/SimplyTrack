...
class AppDelegate: NSObject, NSApplicationDelegate, ObservableObject {
    ...
    private var ipcServiceManager: IPCServiceManager?
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        ipcServiceManager?.startService()
    ...
    @MainActor private func initializeServices() {
        ...
        // Initialize IPC service manager for CLI communication
        ipcServiceManager = IPCServiceManager(modelContainer: modelContainer)
    }
